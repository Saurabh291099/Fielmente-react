...
function Section4() {
  ...
  const text =
  `Want to embrace the Digital Frontier? Boost your hospitality business with our cutting-edge Hospitality Marketing Services & Hospitality Digital Marketing Services. Conquer the online realm, attract a broader audience, and experience a surge in bookings. 
  It’s time to embrace the power of the digital world and release your business’s true potential!`
  const cardData = [
    {
      imgUrl: Img1,
      alt: "hotel-png",
